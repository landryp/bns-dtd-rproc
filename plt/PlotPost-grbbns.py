...
LIKEDIR = '/home/philippe.landry/bns-dtd-rproc/dat/SAGA_grbbns/'
LIKEDIR_DISK = '/home/philippe.landry/bns-dtd-rproc/dat/Battistini_grbbns/'
LIKEPATH = 'SAGA_MP_5M.csv'
LIKEPATH_DISK = 'Battistini16_disk_5M.csv'

POPDIR = '/home/philippe.landry/bns-dtd-rproc/dat/'
POPPATH = 'EuFe_grbbns-100.h5'
...
plt.fill_between(fe_grid,lbs_disk,ubs_disk,facecolor=sns.color_palette()[3],edgecolor=None,alpha=0.2,zorder=4) # 90% CI
plt.fill_between(fe_grid,lbs_disk_std,ubs_disk_std,facecolor=sns.color_palette()[3],edgecolor=None,alpha=0.4,zorder=4) # 68% CI

plt.plot(fe_grid,mds_disk,c=sns.color_palette()[3],alpha=1,label='BNS',zorder=5) # median

#plt.plot(fe_grid,mds,c=sns.color_palette()[3],ls='--',lw=1,alpha=1,zorder=3)
plt.plot(fe_grid,ubs,c=sns.color_palette()[3],ls='--',lw=1,alpha=1,zorder=3)
plt.plot(fe_grid,lbs,c=sns.color_palette()[3],ls='--',lw=1,alpha=1,zorder=3)
...
sns.kdeplot(x=list(alphas_disk)+alphas_disk_reflect,y=np.log10(list(tmins_disk)+tmins_disk_reflect),levels=[0.1,0.32],c=sns.color_palette()[3],cut=3,axes=axx)
sns.kdeplot(x=list(alphas_halo)+alphas_halo_reflect,y=np.log10(list(tmins_halo)+tmins_halo_reflect),levels=[0.1],c=sns.color_palette()[3],cut=3,linewidths=1,linestyles='--',axes=axx)
...
ax.hist(alphas_disk,density=True,bins=np.arange(-2.9,-0.9,0.1),color=sns.color_palette()[3],alpha=0.2)

sns.kdeplot(x=list(alphas)+alphas_reflect,color='k',axes=ax,alpha=0.7,bw_adjust=1.2)
sns.kdeplot(x=list(alphas_disk)+alphas_disk_reflect,c=sns.color_palette()[3],axes=ax,bw_adjust=1.2)
sns.kdeplot(x=list(alphas_halo)+alphas_halo_reflect,c=sns.color_palette()[3],lw=1,ls='--',axes=ax,bw_adjust=1.2)

plt.hist([-10.,-10.],[-10.,-5.],color='k',alpha=0.1,label='prior')
plt.hist([-10.,-10.],[-10.,-5.],color=sns.color_palette()[3],alpha=0.2,label='posterior')
...
ax.hist(np.log10(tmins_disk),density=True,bins=np.arange(-1.9,0.1,0.1),color=sns.color_palette()[3],alpha=0.2)

sns.kdeplot(x=np.log10(list(tmins)+tmins_reflect),color='k',axes=ax,alpha=0.7,bw_adjust=1.2)
sns.kdeplot(x=np.log10(list(tmins_disk)+tmins_disk_reflect),c=sns.color_palette()[3],axes=ax,bw_adjust=1.2)
sns.kdeplot(x=np.log10(list(tmins_halo)+tmins_halo_reflect),c=sns.color_palette()[3],lw=1,ls='--',axes=ax,bw_adjust=1.2)
...
ax.hist(list(ybnss_disk)+ybnss_disk_reflect,density=True,bins=np.arange(1.,31.,1.),color=sns.color_palette()[3],alpha=0.2)

sns.kdeplot(x=list(ybnss)+ybnss_reflect,color='k',axes=ax,alpha=0.7,bw_adjust=1.2)
sns.kdeplot(x=list(ybnss_disk)+ybnss_disk_reflect,c=sns.color_palette()[3],axes=ax,bw_adjust=1.2)
sns.kdeplot(x=list(ybnss_halo)+ybnss_halo_reflect,c=sns.color_palette()[3],lw=1,ls='--',axes=ax,bw_adjust=1.2)
...
sns.kdeplot(x=list(alphas_disk)+alphas_disk_reflect,y=list(ybnss_disk)+ybnss_disk_reflect,levels=[0.1,0.32],c=sns.color_palette()[3],cut=3,axes=axx)
sns.kdeplot(x=list(alphas_halo)+alphas_halo_reflect,y=list(ybnss_halo)+ybnss_halo_reflect,levels=[0.1],c=sns.color_palette()[3],cut=3,linewidths=1,linestyles='--',axes=axx)
...
sns.kdeplot(x=np.log10(list(tmins_disk)+tmins_disk_reflect),y=list(ybnss_disk)+ybnss_disk_reflect,levels=[0.1,0.32],c=sns.color_palette()[3],cut=3,axes=axx)
sns.kdeplot(x=np.log10(list(tmins_halo)+tmins_halo_reflect),y=list(ybnss_halo)+ybnss_halo_reflect,levels=[0.1],c=sns.color_palette()[3],cut=3,linewidths=1,linestyles='--',axes=axx)
